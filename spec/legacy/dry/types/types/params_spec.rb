RSpec.describe Legacy::Dry::Types::Definition do
  describe 'params.nil' do
    subject(:type) { Legacy::Dry::Types['params.nil'] }
  ...
  describe 'params.nil | params.integer' do
    subject(:type) { Legacy::Dry::Types['params.nil'] | Legacy::Dry::Types['params.integer'] }
  ...
  describe 'params.date' do
    subject(:type) { Legacy::Dry::Types['params.date'] }
  ...
  describe 'params.date_time' do
    subject(:type) { Legacy::Dry::Types['params.date_time'] }
  ...
  describe 'params.time' do
    subject(:type) { Legacy::Dry::Types['params.time'] }
  ...
  describe 'params.bool' do
    subject(:type) { Legacy::Dry::Types['params.bool'] }

    it 'coerces to true' do
      (Legacy::Dry::Types::Coercions::Params::TRUE_VALUES + [1]).each do |value|
        expect(type[value]).to be(true)
      end
    end

    it 'coerces to false' do
      (Legacy::Dry::Types::Coercions::Params::FALSE_VALUES + [0]).each do |value|
  ...
  describe 'params.true' do
    subject(:type) { Legacy::Dry::Types['params.true'] }
  ...
  describe 'params.false' do
    subject(:type) { Legacy::Dry::Types['params.false'] }
  ...
  describe 'params.integer' do
    subject(:type) { Legacy::Dry::Types['params.integer'] }
  ...
  describe 'params.float' do
    subject(:type) { Legacy::Dry::Types['params.float'] }
  ...
  describe 'params.decimal' do
    subject(:type) { Legacy::Dry::Types['params.decimal'] }
  ...
  describe 'params.array' do
    subject(:type) { Legacy::Dry::Types['params.array'].of(Legacy::Dry::Types['params.integer']) }
  ...
  describe 'params.hash' do
    subject(:type) { Legacy::Dry::Types['params.hash'].weak(age: Legacy::Dry::Types['params.integer']) }
