RSpec.describe Legacy::Dry::Types::Definition do
  describe 'json.nil' do
    subject(:type) { Legacy::Dry::Types['json.nil'] }
  ...
  describe 'json.date' do
    subject(:type) { Legacy::Dry::Types['json.date'] }
  ...
  describe 'json.date_time' do
    subject(:type) { Legacy::Dry::Types['json.date_time'] }
  ...
  describe 'json.time' do
    subject(:type) { Legacy::Dry::Types['json.time'] }
  ...
  describe 'json.decimal' do
    subject(:type) { Legacy::Dry::Types['json.decimal'] }
  ...
  describe 'json.array' do
    subject(:type) { Legacy::Dry::Types['json.array'].of(Legacy::Dry::Types['integer']) }
  ...
  describe 'json.hash' do
    subject(:type) { Legacy::Dry::Types['json.hash'].weak(age: Legacy::Dry::Types['integer']) }
