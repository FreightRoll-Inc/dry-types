RSpec.describe Legacy::Dry::Types::Hash do
  subject(:hash) { Legacy::Dry::Types['strict.hash'].weak(name: Legacy::Dry::Types['strict.string']) }
  ...
  context 'with a Hash descendant object' do
    ...
    describe '#[]' do
      ...
      it 'raises constraint error with an invalid hash-like object' do
        expect { hash[invalid_hash] }.to raise_error(Legacy::Dry::Types::ConstraintError, /name/)
      end
    end
