RSpec.describe Legacy::Dry::Types::Hash do
  ...
  describe 'hash schema' do
    ...
    before do
      Legacy::Dry::Types.register(
        "phone",
        Legacy::Dry::Types::Definition.new(phone_struct).constructor(-> args { phone_struct.new(*args) })
      )
    end
    ...
    it_behaves_like Legacy::Dry::Types::Definition do
      let(:type) { Legacy::Dry::Types['hash'].schema(hash_schema) }
    end

    it_behaves_like 'Legacy::Dry::Types::Definition#meta' do
      let(:type) { Legacy::Dry::Types['hash'].schema(hash_schema) }
    end
      ...
      let(:hash_schema) do
        {
          ...
          age: "strict.integer",
          active: "params.bool",
          phone: Legacy::Dry::Types['phone'].meta(omittable: true)
        }
      end
  ...
  describe '#map' do
    it 'builds a map type' do
      ...
      expect { map.('foo' => '2') }.to raise_error(Legacy::Dry::Types::MapError)
    end
  end
end
