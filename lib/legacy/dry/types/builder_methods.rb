module Legacy::Dry
  module Types
    module BuilderMethods
      ...
      #
      # @param [Legacy::Dry::Types::Type] type
      #
      # @return [Legacy::Dry::Types::Array]
      def Array(type)
        self::Array.of(type)
      end
      ...
      # @param [Hash{Symbol => Legacy::Dry::Types::Type}] type_map
      #
      # @return [Legacy::Dry::Types::Array]
      # @api public
