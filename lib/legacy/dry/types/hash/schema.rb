require 'legacy/dry/types/fn_container'
...
module Legacy::Dry
  module Types
    class Hash < Definition
      ...
      #
      # @see Legacy::Dry::Types::Default#evaluate
      # @see Legacy::Dry::Types::Default::Callable#evaluate
      class Schema < Hash
        NO_TRANSFORM = Legacy::Dry::Types::FnContainer.register { |x| x }
        SYMBOLIZE_KEY = Legacy::Dry::Types::FnContainer.register(:to_sym.to_proc)
        ...
        def initialize(_primitive, **options)
          ...
          @transform_key = Legacy::Dry::Types::FnContainer[key_fn]
        ...
        def with_key_transform(proc = nil, &block)
          ...
          handle = Legacy::Dry::Types::FnContainer.register(fn)
