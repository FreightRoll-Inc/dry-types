require 'legacy/dry/types/builder'
require 'legacy/dry/types/result'
require 'legacy/dry/types/options'
...
module Legacy::Dry
  module Types
    class Definition
      ...
      # @param (see Legacy::Dry::Types::Success#initialize)
...
require 'legacy/dry/types/array'
require 'legacy/dry/types/hash'
require 'legacy/dry/types/map'
