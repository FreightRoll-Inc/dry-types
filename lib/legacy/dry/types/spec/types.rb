RSpec.shared_examples_for 'Legacy::Dry::Types::Definition without primitive' do
  def be_boolean
...
RSpec.shared_examples_for 'Legacy::Dry::Types::Definition#meta' do
  describe '#meta' do
...
RSpec.shared_examples_for Legacy::Dry::Types::Definition do
  ...
  describe '#constructor' do
    it 'returns a constructor' do
      ...
      expect(constructor).to be_a(Legacy::Dry::Types::Type)
    end
  end
end
