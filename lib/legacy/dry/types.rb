...
require 'legacy/dry/types/version'
require 'legacy/dry/types/container'
require 'legacy/dry/types/inflector'
require 'legacy/dry/types/type'
require 'legacy/dry/types/definition'
require 'legacy/dry/types/constructor'
require 'legacy/dry/types/builder_methods'

require 'legacy/dry/types/errors'
...
module Legacy::Dry
  module Types
    ...
    # @deprecated Include {Legacy::Dry::Types.module} instead
    def self.finalize
      warn 'Legacy::Dry::Types.finalize and configuring namespace is deprecated. Just'\
       ' do `include Legacy::Dry::Types.module` in places where you want to have access'\
       ' to built-in types'
    ...
    # List of type keys defined in {Legacy::Dry::Types.container}
    # @return [<String>]
    def self.type_keys
      container.keys
    end
    ...
    def self.const_missing(const)
      ...
      if type_keys.any? { |key| key.split('.')[0] == underscored }
        raise NameError,
              ...
              'You can access the predefined types with [], e.g. Legacy::Dry::Types["strict.integer"] '\
              'or generate a module with types using Legacy::Dry::Types.module'
      else
        super
      end
    end
...
require 'legacy/dry/types/core' # load built-in types
require 'legacy/dry/types/extensions'
